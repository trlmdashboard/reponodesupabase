    ...
    <div class="dashboard">
        ...
        <div id="cart-section" class="content-section" style="display: none;">
            ...
            <div class="cart-summary">
                <h4>Total: $999.97</h4>
                <button style="background: #28a745; color: white; border: none; padding: 12px 30px; border-radius: 6px; cursor: pointer; font-size: 1.1rem; margin-top: 10px;">Proceed to Checkout</button>
            </div>
        </div>
        ...
        <div id="orders-section" class="content-section" style="display: none;">
            ...
            <div class="order-list">
                <div class="order-item">
                    ...
                    <div>Placed on: Oct 15, 2023</div>
                    <div>Total: $299.99</div>
                    <div>Items: Smart Watch</div>
                </div>
                <div class="order-item">
                    <div class="order-header">
                    ...
                    <div>Placed on: Oct 10, 2023</div>
                    <div>Total: $799.98</div>
                    <div>Items: Laptop Pro</div>
                </div>
                <div class="order-item">
                    <div class="order-header">
                    ...
                    <div>Placed on: Oct 5, 2023</div>
                    <div>Total: $199.99</div>
                    <div>Items: Wireless Headphones</div>
                </div>
            </div>
        </div>
        ...
        <div id="incentives-section" class="content-section" style="display: none;">
            ...
            <div class="rewards-grid">
                <div class="reward-card">
                    ...
                    <div class="reward-description">Earn points on every purchase</div>
                    <div class="reward-points">1,250 Points</div>
                </div>
                <div class="reward-card">
                    <div class="reward-icon">💰</div>
                    <div class="reward-title">Cashback</div>
                    <div class="reward-description">5% cashback on all orders</div>
                    <div class="reward-points">$45.00 Available</div>
                </div>
                <div class="reward-card">
                    <div class="reward-icon">🎁</div>
                    <div class="reward-title">Special Offers</div>
                    <div class="reward-description">Exclusive member discounts</div>
                    <div class="reward-points">3 Offers</div>
                </div>
                <div class="reward-card">
                    <div class="reward-icon">🏆</div>
                    <div class="reward-title">VIP Status</div>
                    <div class="reward-description">You're a Gold Member</div>
